...
import { getAllAvaliacoes, type AvaliacaoRow } from '../services/petServices';
    ...
    <div className="p-2 md:p-0">
      ...
      {rows.length ? (
        <div className="space-y-3">
          {rows.map((r, i) => (
            <div key={`${r.petId}-${r.usuario}-${i}`} className="bg-white/10 p-4 rounded-lg border border-white/10">
